...
// Request contains the parameters for the Bluetooth Company Lookup API.
//
// Parameters:
...
// ResponseData contains the data returned by the Bluetooth Company Lookup API.
type ResponseData struct {
	CompanyId int `json:"companyId"`
	CompanyIdHex string `json:"companyIdHex"`
