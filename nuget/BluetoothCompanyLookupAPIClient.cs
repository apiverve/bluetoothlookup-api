...
namespace APIVerve.API.BluetoothCompanyLookup
{
    ...
    /// <summary>
    /// Client for the BluetoothCompanyLookup API
    /// </summary>
    public class BluetoothCompanyLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/bluetoothlookup";
        ...
        {
            { "companyid", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public BluetoothCompanyLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BluetoothCompanyLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BluetoothCompanyLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BluetoothCompanyLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BluetoothCompanyLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(BluetoothCompanyLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BluetoothCompanyLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BluetoothCompanyLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BluetoothCompanyLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BluetoothCompanyLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BluetoothCompanyLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BluetoothCompanyLookupQueryOptions options)
        {
