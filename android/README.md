# Bluetooth Company Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:bluetoothlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.bluetoothlookup.BluetoothCompanyLookupAPIClient;
import com.apiverve.bluetoothlookup.APIResponse;
import com.apiverve.bluetoothlookup.APIException;

// Initialize the client
BluetoothCompanyLookupAPIClient client = new BluetoothCompanyLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("companyid", "76");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bluetoothlookup](https://docs.apiverve.com/ref/bluetoothlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/bluetoothlookup](https://docs.apiverve.com/ref/bluetoothlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bluetoothlookup-api/issues)
