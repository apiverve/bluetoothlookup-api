...
namespace APIVerve\Bluetoothlookup;
...
/**
 * Client for the Bluetooth Company Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/bluetoothlookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bluetoothlookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BluetoothlookupClient] {$message}\n";
        }
    }
}
